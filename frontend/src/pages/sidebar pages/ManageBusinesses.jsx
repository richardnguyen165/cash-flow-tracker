...
function ManageBusinesses() {
  const businesses = [
    ["Northshore Capital", "Verified", "12 active contracts"],
    ["Silverline Consulting", "Pending Review", "4 open invoices"],
    ["Meridian Group", "Flagged", "Balance discrepancy review"],
  ];
    ...
    >
      <section>
        ...
        <p className="mt-3 max-w-3xl text-lg text-[#64748b]">
          Monitor business registrations, current standing, and issues that need administrative follow-up.
        </p>
      </section>
          ...
          <table className="min-w-full divide-y divide-[#eef2f6]">
            <thead className="bg-[#f8fafc]">
              <tr className="text-left text-xs uppercase tracking-[0.18em] text-[#94a3b8]">
                {["Business", "Status", "Notes"].map((header) => (
